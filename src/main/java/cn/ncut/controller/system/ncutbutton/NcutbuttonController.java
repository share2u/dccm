package cn.ncut.controller.system.ncutbutton;
 ...
 * 
*
*<p>Title:NcutbuttonController</p>
*<p>Description:按钮管理</p>
*<p>Company:ncut</p> 
* @author lph 
* @date 2016-12-5下午8:33:13
*
 */
@Controller
@RequestMapping(value="/ncutbutton")
public class NcutbuttonController extends BaseController {
	
	String menuUrl = "ncutbutton/list.do"; //菜单地址(权限用)
	@Resource(name="ncutbuttonService")
	private NcutbuttonManager ncutbuttonService;
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Ncutbutton");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "edit")){return null;} //校验权限
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		ncutbuttonService.edit(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = ncutbuttonService.list(page);	//列出Fhbutton列表
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ncutbuttonService.findById(pd);	//根据ID读取
		mv.setViewName("system/fhbutton/fhbutton_edit");
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			ncutbuttonService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = ncutbuttonService.listAll(pd);
