package cn.ncut.controller.system.ncutsms;
 ...
 * 
*
*<p>Title:NcutsmsController</p>
*<p>Description:站内信，暂不使用</p>
*<p>Company:ncut</p> 
* @author lph 
* @date 2016-12-5下午8:34:06
*
 */
@Controller
@RequestMapping(value="/fhsms")
public class NcutsmsController extends BaseController {
	
	String menuUrl = "fhsms/list.do"; //菜单地址(权限用)
	@Resource(name="fhsmsService")
	private NcutsmsManager fhsmsService;
