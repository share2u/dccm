package cn.ncut.controller.system.userphoto;
...
import cn.ncut.util.DelAllFile;
import cn.ncut.util.PageData;
import cn.ncut.util.Jurisdiction;
import cn.ncut.util.PathUtil;
import cn.ncut.util.Tools;
import cn.ncut.service.system.userphoto.UserPhotoManager;

/**
 * 
*
*<p>Title:UserPhotoController</p>
*<p>Description:用户头像</p>
*<p>Company:ncut</p> 
* @author lph 
* @date 2016-12-5下午8:35:03
*
 */
@Controller
