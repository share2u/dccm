...
public class CreditController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("CREDIT_ID", this.get32UUID());	//主键
		pd.put("UID", "");	//用户编号
		pd.put("CREDIT", "0");	//积分
		pd.put("STATUS", "0");	//状态
	...
	public Object delete() throws Exception{
		...
		if(Integer.parseInt(creditmxService.findCount(pd).get("zs").toString()) > 0){
			errInfo = "false";
		}else{
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Credit");
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("user/credit/credit_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("user/credit/credit_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).get("CREDIT").toString());	//2
