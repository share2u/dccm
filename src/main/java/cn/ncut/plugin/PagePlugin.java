...
import cn.ncut.util.ReflectHelper;
import cn.ncut.util.Tools;
/**
 * 
*
*<p>Title:PagePlugin</p>
*<p>Description:分页插件</p>
*<p>Company:ncut</p> 
* @author lph 
* @date 2016-12-5下午8:42:30
*
 */
		...
		if(ivk.getTarget() instanceof RoutingStatementHandler){
			...
			if(mappedStatement.getId().matches(pageSqlId)){ //拦截需要分页的SQL
				...
				if(parameterObject==null){
					...
					String fhsql = sql.toUpperCase();
					int index = fhsql.lastIndexOf("ORDER BY");
					if (index != -1) {
