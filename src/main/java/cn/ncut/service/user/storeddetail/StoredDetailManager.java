package cn.ncut.service.user.storeddetail;
 ...
 * @version
 */
public interface StoredDetailManager{
	...
	public List<PageData> selectstoreddetailGroups(PageData pd)throws Exception;
