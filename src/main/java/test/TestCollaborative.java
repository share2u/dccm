...
public class TestCollaborative {
    ...
    public void test() throws Exception {
    	...
    	CollaborativeFiltering collaborativeFiltering = (CollaborativeFiltering) ac.getBean("collaborativeFiltering");
    	collaborativeFiltering.Application();
        long endTime = System.currentTimeMillis();    //获取结束时间
        System.out.println("程序运行时间：" + (endTime - startTime)/60000 + "min");    //输出程序运行时间
