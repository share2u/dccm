...
import cn.ncut.recommend.segmentation.SegmentationOperation;
public class TestSegmentation {
    ...
    public void setUp() throws Exception {
        ...
        //String co = "spring/ApplicationContext-main.xml";
    ...
    public void test() throws Exception {
    	SegmentationOperation operationSegmentation  = (SegmentationOperation) ac.getBean("operationSegmentation");
    	operationSegmentation.KmeansOperation();
