...
import cn.ncut.recommend.classify.ClassifyUsers;


public class TestClassifyUsers {
    ...
    public void test() throws Exception {
        ClassifyUsers classifyUsers  = (ClassifyUsers) ac.getBean("classifyUsers");
        classifyUsers.Classify();
    }
