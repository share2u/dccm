...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
		...
		<link rel="stylesheet" href="static/css/wechat/easyui.css">
		<link rel="stylesheet" href="static/css/wechat/icon.css">
		<script type="text/javascript">
			// 暂时设置为5分钟刷新一次
			/*
			var value = 180 * 1000;
			setInterval("statisticsTime()", value);			
			
			function statisticsTime(){
				var start = Date.now();
				$.ajax({
					url : 'weChatDialog/statisticTime',
					type : 'POST',
					dataType : "json",
					async : true,
					...
					success : function(data) {
						...
						$.ajax({
							url : 'weChatDialog/statisticTime',
							type : 'POST',
							data : {"flag" : "true", "start" : start, "mid" : mid, "end" : Date.now()},
							dataType : "json",
							async : true,
							contentType : "application/x-www-form-urlencoded;charset=utf-8",
							success : function(data) {
