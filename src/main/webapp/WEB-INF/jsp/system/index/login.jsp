		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				<div class="control-group normal_text">
					<h3>
						大诚中医客户管理系统<!-- <img src="static/login/logo.png" alt="Logo" /> -->
					</h3>
				</div>
...
<%-- 						<c:if test="${pd.isZhuce == 'yes' }">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 北方工业大学 计算机应用研究所</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "ncut1110"+loginname+",ncut,"+password+"dccm"+",ncut,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
