			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="staff/listStaffsForWindow.do" method="post" name="staffForm" id="staffForm">
									...
									<c:forEach items="${staffList}" var="staff" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='radio' name="fhadmin" value="${staff.USERNAME }" onclick="setStaff(this.value)" class="ace"/><span class="lbl"></span></label>
											</td>
											<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class="center">${staff.NUMBER }</td>
											<td class="center"><a onclick="viewStaff('${staff.USERNAME}')" style="cursor:pointer;">${staff.USERNAME }</a></td>
											<td class="center">${staff.NAME }</td>
											<td class="center">${staff.ROLE_NAME }</td>
										</tr>
									</c:forEach>
									</c:if>
									<c:if test="${QX.cha == 0 }">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<a class="btn btn-mini btn-primary" onclick="staffBinding();">绑定</a>
