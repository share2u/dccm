			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="queryMember/credit.do" method="post" name="Form" id="Form">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:15px;">
								 	<select class="chosen-select form-control" name="isUsed" id="isUsed" data-placeholder="请选择" style="vertical-align:top;width: 120px;">
									<option value="${pd.isUsed}"></option>
								...
								<c:when test="${not empty varList}">
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">${var.SERVICECOST_ID}</td>
											<td class='center'>${var.ORDER_MONEY}</td>
											<td class='center'>${var.PAY_MONEY}</td>
											<td class='center'>${var.REFUND}</td>
										
										<%--	<td class='center'><c:if test="${var.isUsed==1}">已使用</c:if>
												   <c:if test="${var.isUsed==0}">未使用</c:if></td>
											<%-- <td class="center">
