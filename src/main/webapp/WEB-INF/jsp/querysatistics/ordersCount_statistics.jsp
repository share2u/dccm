				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="statisticsOrder/staticticsOrdersSum.do" method="post"
								...
								<hr>
								<!-- <div style="width: 100%;background-color:#F7F7F7;height: 20px;"></div> -->
...
<script type="text/javascript">
								...
								var option = {
									...
									tooltip : {},
									legend : {data:['待支付','已关闭','已预约','已过期','待评价','已完成','已取消','总数']
									},
									xAxis : {
										name:'门店名称',
										nameRotate :5,
