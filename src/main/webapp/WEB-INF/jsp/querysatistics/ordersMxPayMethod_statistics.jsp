				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="statisticsOrder/staticticsOrdersPayMethod.do" method="post"
								name="orderMxForm" id="orderMxForm">
...
<script type="text/javascript">
								...
								var myChart = echarts.init(document
										.getElementById('ordersMxMoney'));
								var ordersSum = eval("("+'${ordersMxPayMethod}'+")");
								var xData = new Array();
								...
								$.each(ordersSum,function(storeId,storeOrderDetail){
									...
									y0DetailData.push(storeOrderDetail[2]);
									y1DetailData.push(storeOrderDetail[3]);
									y2DetailData.push(storeOrderDetail[4]);
									y3DetailData.push(storeOrderDetail[5]);
									y4DetailData.push(storeOrderDetail[6]);
									y5DetailData.push(storeOrderDetail[7]);
									y6DetailData.push(storeOrderDetail[8]);
								...
								var option = {
									...
									legend : {
										left:'20%',
										data : [ '微信支付','支付宝支付','储值卡余额支付','储值卡返点支付','现金支付','银行卡支付','钱包支付','实收总额']
									},
									xAxis : {
										name:'门店名称',
										nameRotate :5,
