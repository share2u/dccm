				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						 ...
						 <!-- 检索  -->
						<form action="paymedicinal/show.do" method="post" name="Form" id="Form">
				...
				if (result) {
					...
					$.ajax({
						...
						success : function(data) {
							if(data.success){
								 bootbox.dialog({
									message: "<span class='bigger-110'>订单创建成功！  <br><br> <a href='paymedicinal/show.do'>返回</a></span>",    
								
								}); 
								
							}else{
								bootbox.dialog({
									message: "<span class='bigger-110'>创建订单失败!  <br><br> <a href='paymedicinal/show.do'>返回</a></span>",    
								});
							}
						}
					});
