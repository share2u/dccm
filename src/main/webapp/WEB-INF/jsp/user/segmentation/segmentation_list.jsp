			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="segmentation/list.do" method="post" name="Form" id="Form">
							<table style="margin-top:5px;">
							<tr>
								
								

								<td style="padding-left:10px;">请选择用户类别：</td>
								<td style="vertical-align:top;padding-left:15px;">
								 	<select class="chosen-select form-control" name="groupid" id="sex" data-placeholder="请选择" style="vertical-align:top;width: 120px;">
									<option value="${pd.groupid}"></option>
									<option value="1">用户类别1</option>
									<option value="2">用户类别2</option>
									<option value="3">用户类别3</option>
									<option value="4">用户类别4</option>
									<option value="5">用户类别5</option>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">用户个人折扣</th>
									<th class="center">用户关注时间(天)</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td align='right'>${var.refundcount}</td>
											<td align='right'>${var.refundmoney}</td>
											<td class='center'>${var.groupid}	</td>
