...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="userdiscount/goShowDiscount.do" method="post" name="Form" id="Form">
						<div id="zhongxin" style="padding-top: 13px;">
						<input type="hidden" id="UID" name="UID" value="${HiddenUid}"/>
						<table style="margin-top:5px;">
							<tr>
								<td>请选择创建日期：</td>
								<td style="padding-left:2px;"><input class="span10 date-picker" name="startTime" name="startTime"  value="${START}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="开始日期" title="开始日期"/></td>
								<td style="padding-left:2px;"><input class="span10 date-picker" name="endTime" name="endTime"  value="${END}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="结束日期" title="结束日期"/></td>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<!-- <th class="center">是否可以使用</th> -->
									<th class="center">是否已经使用</th>
								...
								<c:when test="${not empty pdlist}">
									...
									<c:forEach items="${pdlist}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><c:if test="${var.ISUSED==0}">未使用</c:if>
												   <c:if test="${var.ISUSED==1}">已使用</c:if></td>
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>userdiscount/excel.do';
		}
	</script>
