				...
				<div class="page-content">
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">请输入姓名/手机号/用户类型/城市：
										<span class="input-icon">
											<input type="text" placeholder="姓名/手机号/用户类型/城市" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入关键词"/>
											<i class="ace-icon fa fa-search nav-search-icon"></i>
										</span>
									</div>
								</td>
								<td style="padding-left:10px;">请选择关注时间：</td>
								...
								<td style="padding-left:10px;">请选择客户来源：</td>
								<td style="vertical-align:top;padding-left:15px;">
								 	<select class="chosen-select form-control" name="SOURCE" id="sex" data-placeholder="请选择" style="vertical-align:top;width: 120px;">
									<option value="${pd.SOURCE}"></option>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">初诊日期</th>
									<th class="center">会员类型</th>
									<th class="center">个人优惠比例</th>
									<th class="center">用户组优惠比例</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.first_date}</td>
											...
											<td class='center'> 
												<c:if test="${var.source==1}">客服录入</c:if>
											...
											<%-- <td class='center'>
												<c:if test="${var.illness==1}">病种1</c:if>
												   <c:if test="${var.illness==2}">病种2</c:if></td>
											</td> --%>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<!--<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="del('${var.uid}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<c:if test="${QX.del == 1 }">
														    <li>
																<a style="cursor:pointer;" onclick="del('${var.uid}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
