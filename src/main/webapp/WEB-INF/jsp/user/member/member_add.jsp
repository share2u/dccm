							...
							-->
										...
										<tr>
											...
											<td><input type="text" name="PHONE" id="PHONE"
												...
												title="电话号码" style="width:98%;" onblur="findCityByPhone(this)" />
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><select class="chosen-select form-control"
												name="USERCATEGORY_ID" id="CHILD" data-placeholder="请选择团购组"
										...
										<tr>
											...
											<td><input type="text" name="PROPORTION" id="PROPORTION" value="1.0" maxlength="255" placeholder="这里输入个人优惠比例" title="个人优惠比例" style="width:98%;"/>
											</td>
