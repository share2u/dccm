...
<c:if test="${'edit' == msg }">
	<div>
		<iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/ordermx/list.do?ORDER_ID=${pd.ORDER_ID}" style="margin:0 auto;width:805px;height:368px;;"></iframe>
	</div>
</c:if>
