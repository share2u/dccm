		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="suggestion/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="SUGGESTION_ID" id="SUGGESTION_ID" value="${pd.SUGGESTION_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">用户姓名:</td>
								<td><input type="number" name="UID" id="UID" value="${pd.UID}" maxlength="32" placeholder="这里输入用户姓名" title="用户姓名" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">内容:</td>
								<td><input type="text" name="CONTENT" id="CONTENT" value="${pd.CONTENT}" maxlength="500" placeholder="这里输入内容" title="内容" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="number" name="METHOD" id="METHOD" value="${pd.METHOD}" maxlength="32" placeholder="这里输入来源" title="来源" style="width:98%;"/></td>
							</tr>
							<tr>
